<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageBatchProductQualityAssuranceReview.aspx.cs" Inherits="BioPM.PageBatchProductQualityAssuranceReview" %>
...
<script runat="server">
    ...
    protected string GetPageAction(string BATCH)
    {
        ...
        else
        {
            switch (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndType(BATCH, "3")[2].ToString().ToLower())
            {
                ...
                case "qa review":
                    {
                        return "<td align='center'><a class='edit' href='PageQualityAssuranceTransactionReviewSecondStage.aspx?key=" + BATCH + "'> REVIEW </a></td>";
                    }
                case "qa corection":
                    {
                        return "<td align='center'></td>";
    ...
    protected String GenerateDataBatch()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.BatchCatalog.GetBatchByReviewerAndType(Session["username"].ToString(), "3"))
        {
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        Batch Product Quality Assurance Detail
