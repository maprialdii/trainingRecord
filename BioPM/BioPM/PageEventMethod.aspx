...
<script runat="server">
    ...
    {
        BioPM.ClassObjects.Reason.InsertReason(txtReason.Text, "Delete Method", Session["username"].ToString());
    }
    ...
    protected String GenerateDataMethod()
    {
        ...
        {
            htmlelement += "<tr class=''><td>" + data[1].ToString() + "</td><td><a class='edit' href='FormUpdateEventMethod.aspx?key=" + data[0].ToString() + "'>Edit</a></td><td><a data-toggle='modal' ID='btnAction' runat='server' Text='Delete' href='PageInformation.aspx?key=" + data[0].ToString() + "&type=23'>Delete</a></td></tr>";
        }
