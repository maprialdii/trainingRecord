<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageSampleDilutionRandom.aspx.cs" Inherits="BioPM.PageSampleDilutionRandom" %>
...
<script runat="server">
    ...
    protected String GenerateDataAnimalTest()
    {
        ...
        {
            htmlelement += "<tr class=''><td>" + data[7].ToString() + "</td><td>" + data[6].ToString() + "</td><td>" + data[9].ToString() + "</td><td>" + data[0].ToString() + "</td><td>" + (data[8].ToString() == "0.0000" ? "" : data[8].ToString()) + "</td></tr>";
        }
