<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateMultiAnimalRandomTetanus.aspx.cs" Inherits="BioPM.FormGenerateMultiAnimalRandomTetanus" %>
...
<script runat="server">
    ...
    protected void InsertAnimalRandomIntoDatabase()
    {
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, "14", "M", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, "14", "F", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
            if ((i + 1) % numberdivided == 0) cagenumber++;
        }
    }
