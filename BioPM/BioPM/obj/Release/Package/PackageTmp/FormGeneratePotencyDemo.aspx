<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGeneratePotencyDemo.aspx.cs" Inherits="BioPM.FormGeneratePotencyDemo" %>
...
<script runat="server">
    ...
    protected void GetRandomAnimalDate()
    {
        ...
        {
            ddlRandomDate.Items.Add(new ListItem(BioPM.ClassEngines.DateFormatFactory.GetDateFormat(data[1].ToString()) + " - " + data[2].ToString() + " (ID" + data[0].ToString() + " - " + GetAnimalSex(data[4].ToString()) + ")", data[0].ToString()));
        }
    }
    ...
    protected void InsertDilutionTestIntoDatabase()
    {
        ...
        while (index < ((dilution * animalperdilution) / animalpercage))
        {
            ...
            {
                BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "13", itemid, malecagenumbers[0].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
            ...
            {
                BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "13", itemid, femalecagenumbers[0].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
