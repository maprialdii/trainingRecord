<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateDiphtheriaPotency.aspx.cs" Inherits="BioPM.FormGenerateDiphtheriaPotency" %>
...
<script runat="server">
    ...
    protected void GetRandomAnimalDate()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.QualityControlCatalog.GetAnimalRandomDateByType("13"))
        {
    ...
    protected void InsertDilutionTestIntoDatabase()
    {
        ...
        {
            BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "13", itemid, numbers[i].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
...
<head>
    ...
    <title>DIPHTHERIA POTENCY</title>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        DIPHTHERIA POTENCY RANDOM SAMPLE ENTRY FORM
