<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateMultiAnimalRandom.aspx.cs" Inherits="BioPM.FormGenerateMultiAnimalRandom" %>
...
<script runat="server">
    ...
    protected void SetQCType()
    {
        ...
        else if (Session["coctr"].ToString() == "64100") 
		{
			ddlQCType.Items.Add(new ListItem("Diphtheria Potency", "13"));
			ddlQCType.Items.Add(new ListItem("Tetanus Potency", "14"));
			ddlQCType.Items.Add(new ListItem("Pertussis Potency", "15"));
    ...
    protected void InsertAnimalRandomIntoDatabase()
    {
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, ddlQCType.SelectedValue, "M", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, ddlQCType.SelectedValue, "F", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
            if ((i + 1) % numberdivided == 0) cagenumber++;
        }
    }
