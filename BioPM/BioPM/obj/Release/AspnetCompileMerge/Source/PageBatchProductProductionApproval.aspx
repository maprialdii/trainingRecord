<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageBatchProductProductionApproval.aspx.cs" Inherits="BioPM.PageBatchProductProductionApproval" %>
    ...
    protected string GetPageAction(string BATCH)
    {
        ...
        else
        {
            switch (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatch(BATCH, "2")[2].ToString().ToLower())
            {
                ...
                case "reviewe":
                    {
                        return "<td align='center'><a class='edit' href='PageProductionTransaction.aspx?key=" + BATCH + "'> APPROVE </a></td>";
                    }
                case "corection":
                    {
                        return "<td align='center'></td>";
