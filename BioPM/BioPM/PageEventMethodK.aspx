<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageEventMethodK.aspx.cs" Inherits="BioPM.PageEventMethodK" %>

<!DOCTYPE html>
<!-- Page Event Method untuk karyawan -->
<script runat="server">
    ...
    protected String GenerateDataMethod()
    {
        ...
        {
            htmlelement += "<tr class=''><td>" + data[1].ToString() + "</td></tr>";
        }
