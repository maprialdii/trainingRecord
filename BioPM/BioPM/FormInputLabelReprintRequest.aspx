<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormInputLabelReprintRequest.aspx.cs" Inherits="BioPM.FormInputLabelReprintRequest" %>
...
<script runat="server">
    ...
    protected void SetDataToForm()
    {
        ...
        txtPrintStatus.Text = "Re-Print";
        
    }

    protected void InsertLabelPrintData()
    {
        Session["PRTID"] = BioPM.ClassObjects.LabelCatalog.GetMaxPrintID();
        object[] values = BioPM.ClassObjects.LabelCatalog.GetBatchDetailByBatch(txtBatch.Text);
        BioPM.ClassObjects.LabelCatalog.InsertLabelPrintData(Session["PRTID"].ToString(), txtBatch.Text, "X", txtQuantity.Text, txtRequestDate.Text, values[4].ToString(), "", txtNumberOfLabel.Text, txtReason.Text, Session["username"].ToString());
    }
    ...
    protected void InsertLabelPrintFlow()
    {
        ...
        {
            if ((BioPM.ClassObjects.LabelCatalog.ValidatePrintFlow(Session["PRTID"].ToString(), _ReviewerData.Rows[i]["PERNR"].ToString()) == 0))
                BioPM.ClassObjects.LabelCatalog.InsertLabelPrintFlow(Session["PRTID"].ToString(), "1", "PENDING", _ReviewerData.Rows[i]["PERNR"].ToString(), "", Session["username"].ToString());
        }
    }
    
    protected void btnSave_Click(object sender, EventArgs e)
    {
        InsertLabelPrintData();
            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" ID="lblNumberOfLabel" Visible="true" class="col-sm-3 control-label"> NUMBER OF LABEL </asp:Label>
                            <div class="col-lg-3 col-md-4">
                                <asp:TextBox ID="txtNumberOfLabel" Visible="true" runat="server" class="form-control m-bot15"></asp:TextBox>
                                <span class="help-block">Separate with comma, e.g. 2, 3, 6, 8, 10 </span>
                            </div>
                        </div>

                        <div class="form-group">
                            <asp:Label runat="server" ID="lblReason" Visible="true" class="col-sm-3 control-label"> REASON </asp:Label>
                            <div class="col-lg-3 col-md-4">
                                <asp:TextBox ID="txtReason" TextMode="MultiLine" Visible="true" runat="server" class="form-control m-bot15"></asp:TextBox>
                            </div>
                        </div>
