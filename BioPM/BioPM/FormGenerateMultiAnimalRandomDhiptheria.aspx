<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateMultiAnimalRandomDhiptheria.aspx.cs" Inherits="BioPM.FormGenerateMultiAnimalRandomDhiptheria" %>
...
<script runat="server">
    ...
    protected void InsertAnimalRandomIntoDatabase()
    {
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, "13", "M", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, "13", "F", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
            if ((i + 1) % numberdivided == 0) cagenumber++;
        }
    }
