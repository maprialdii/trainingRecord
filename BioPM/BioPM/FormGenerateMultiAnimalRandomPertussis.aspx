<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateMultiAnimalRandomPertussis.aspx.cs" Inherits="BioPM.FormGenerateMultiAnimalRandomPertussis" %>
...
<script runat="server">
    ...
    protected void InsertAnimalRandomIntoDatabase()
    {
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, "15", "M", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
        ...
        {
            BioPM.ClassObjects.AnimalRandomCatalog.InsertAnimalRandom(RNDID, txtRandomDate.Text, ddlSampleType.SelectedValue, "15", "F", cagenumber.ToString(), numbers[i].ToString(), Session["username"].ToString());
            if ((i + 1) % numberdivided == 0) cagenumber++;
        }
    }
