<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageQualityAssuranceTransaction.aspx.cs" Inherits="BioPM.PageQualityAssuranceTransaction" %>
...
<script runat="server">
    ...
    protected void GenerateDataFormula()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.ProductionCatalog.GetProductFormulaByBatch(txtBatch.Text))
        {
            System.Data.DataTable dt = _FormulaData;
            int newid = dt.Rows.Count + 1;
            dt.Rows.Add(new object[] { index.ToString(), data[3].ToString(), data[4].ToString(), Convert.ToDecimal(data[5]).ToString("F"), "", data[6].ToString(), "false" });
            index++;
            _FormulaData = dt;
        }
        this.GridViewFormula.DataSource = _FormulaData;
