<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageTargetTrainingK.aspx.cs" Inherits="BioPM.PageTargetTrainingK" %>

<!DOCTYPE html>
<!-- Page Target Training untuk karyawan -->
<script runat="server">
    string evtId = "";
    ...
    protected String GenerateDataTargetTraining()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.ComDevEvent.GetComdevEventTargetByEvent(Request.QueryString["key"].ToString()))
        {
            ...
            htmlelement += "<tr class=''><td>" + data[3].ToString() + "</td><td>" + data[4].ToString() + "</td></tr>";
        }
