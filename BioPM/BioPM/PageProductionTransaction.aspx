...
<script runat="server">
    ...
    protected void SetDataToForm()
    {
        ...
        if (BioPM.ClassObjects.ProductionCatalog.ValidateProductBatch(BATCH) >= 1)
        {
            ...
            txtProductStatus.Text = BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "2") == null ? "IN PROCESS" : BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "2")[2].ToString().ToUpper();
