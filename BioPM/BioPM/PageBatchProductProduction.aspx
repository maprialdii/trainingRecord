<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageBatchProductProduction.aspx.cs" Inherits="BioPM.PageBatchProductProduction" %>
...
<script runat="server">
    ...
    {
        if (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "2") == null)
        {
            return "<span class='label label-warning'> IN PROCESS </span>";
        }
        else
        {
            switch (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "2")[2].ToString().ToLower())
            {
                case "quarantine":
                    {
