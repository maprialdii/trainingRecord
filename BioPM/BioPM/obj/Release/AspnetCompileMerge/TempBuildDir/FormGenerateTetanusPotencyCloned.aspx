<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateTetanusPotencyCloned.aspx.cs" Inherits="BioPM.FormGenerateTetanusPotencyCloned" %>
...
<script runat="server">
    ...
    protected void InsertDilutionTestIntoDatabase()
    {
        ...
        while (index < ((dilution * animalperdilution) / animalpercage))
        {
            ...
            {
                BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "14", itemid, malecagenumbers[0].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
            ...
            {
                BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "14", itemid, femalecagenumbers[0].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
