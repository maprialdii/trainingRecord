...
namespace BioPM.ClassObjects
{
    ...
    {
        public static void InsertQualityControlType(QualityControlType qctype, string USRDT)
        {
            string date = DateTime.Today.ToString("MM/dd/yyyy");
            SqlConnection conn = GetConnection();
            string sqlCmd = @"INSERT INTO biopm.QC_TYPE (BEGDA, ENDDA, QCTYP, QCTNM, ALIAS, CHGDT, USRDT)
                            VALUES('" + date + "','" + "12/31/9999" + "','" + qctype.QualityControlTypeID + "','" + qctype.QualityControlTypeName + "','" + qctype.QualityControlTypeAlias + "','" + date + "', '" + USRDT + "')";
        ...
        public static void UpdateQualityControlType(QualityControlType qctype, string USRDT)
        {
            string date = DateTime.Today.ToString("MM/dd/yyyy");
            SqlConnection conn = GetConnection();
            string sqlCmd = @"UPDATE biopm.QC_TYPE SET QCTNM = '" + qctype.QualityControlTypeName + "', ALIAS = '" + qctype.QualityControlTypeAlias + "', CHGDT = '" + date + "', USRDT = '" + USRDT + "' WHERE (VACGR = '" + qctype.QualityControlTypeID + "')";
        ...
        public static QualityControlType GetQualityControlTypeByID(string id)
        {
            SqlConnection conn = GetConnection();
            string sqlCmd = @"SELECT DISTINCT QT.QCTYP, QT.QCTNM, QT.ALIAS 
                            FROM biopm.QC_TYPE QT
                            WHERE QT.QCTYP = '" + id + "'";
            ...
            try
            {
                ...
                QualityControlType qctype = new QualityControlType();

                while (reader.Read())
                {
                    qctype = QualityControlFactory.CreateQualityControlType(reader[0].ToString(), reader[1].ToString(), reader[2].ToString());
                }
        ...
        public static List<QualityControlType> GetAllQualityControlType()
        {
            SqlConnection conn = GetConnection();
            string sqlCmd = @"SELECT DISTINCT QT.QCTYP, QT.QCTNM, QT.ALIAS 
                            FROM biopm.QC_TYPE QT ORDER BY QT.QCTNM";
            SqlCommand cmd = GetCommand(conn, sqlCmd);
            ...
            try
            {
                conn.Open();
                SqlDataReader reader = GetDataReader(cmd);
                List<QualityControlType> qctypes = new List<QualityControlType>();
                while (reader.Read())
                {
                    qctypes.Add(QualityControlFactory.CreateQualityControlType(reader[0].ToString(), reader[1].ToString(), reader[2].ToString()));
                }
                return qctypes;
            }
            finally
        ...
        public static void InsertQualityControl(QualityControl qualitycontrol, string USRDT)
        {
            string date = DateTime.Today.ToString("MM/dd/yyyy");
            SqlConnection conn = GetConnection();
            string sqlCmd = @"INSERT INTO biopm.QC_REFERENSI_PRODUK (BEGDA, ENDDA, PRDID, QCTYP, QCSTY, QCSNM, ALIAS, QCREQ, QCSYA, QCMIN, QCMAX, UNTID, CHGDT, USRDT) 
                            VALUES('" + date + "','" + "12/31/9999" + "','" + qualitycontrol.ProductID + "','" + qualitycontrol.QualityControlTypeID + "','" + qualitycontrol.QualityControlID + "','" + qualitycontrol.QualityControlName + "','" + qualitycontrol.QualityControlAlias + "','" + qualitycontrol.QualityControlRequirement + "','" + qualitycontrol.QualityControlRequirementAlias + "','" + qualitycontrol.QualityControlMinValue + "','" + qualitycontrol.QualityControlMaxValue + "','" + qualitycontrol.QualityControlUnit + "','" + date + "', '" + USRDT + "')";
            SqlCommand cmd = DatabaseFactory.GetCommand(conn, sqlCmd);
        ...
        public static void UpdateQualityControl(QualityControl qualitycontrol, string USRDT)
        {
            string date = DateTime.Today.ToString("MM/dd/yyyy");
            SqlConnection conn = GetConnection();
            string sqlCmd = @"UPDATE biopm.QC_REFERENSI_PRODUK SET QCTYP = '" + qualitycontrol.QualityControlTypeID + "', QCSNM = '" + qualitycontrol.QualityControlName + "', ALIAS = '" + qualitycontrol.QualityControlAlias + "', QCREQ = '" + qualitycontrol.QualityControlRequirement + "', QCSYA = '" + qualitycontrol.QualityControlRequirementAlias + "', QCMIN ='" + qualitycontrol.QualityControlMinValue + "', QCMAX ='" + qualitycontrol.QualityControlMaxValue + "', CHGDT = '" + date + "', USRDT = '" + USRDT + "' WHERE (QCSTY = '" + qualitycontrol.QualityControlID + "' AND PRDID = '" + qualitycontrol.ProductID + "')";
        ...
        public static QualityControl GetQualityControlByID(string id)
        {
            SqlConnection conn = GetConnection();
            string sqlCmd = @"SELECT DISTINCT QC.PRDID, QC.QCSTY, QC.QCSNM, QC.ALIAS, QC.QCREQ, QC.QCSYA, QC.QCMIN, QC.QCMAX, UNTID, QT.QCTYP, 
                            QT.QCTNM, QC.ALIAS
                            FROM biopm.QC_REFERENSI_PRODUK QC, biopm.QC_TYPE QT
                            WHERE QT.QCTYP = QC.QCTYP AND QC.QCSTY = '" + id + "'";
            SqlCommand cmd = GetCommand(conn, sqlCmd);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    qualitycontrol = QualityControlFactory.CreateQualityControl(reader[0].ToString(), reader[1].ToString(), reader[2].ToString(), reader[3].ToString(), reader[4].ToString(), reader[5].ToString(),
        ...
        public static List<QualityControl> GetQualityControlByProductID(string id)
        {
            SqlConnection conn = GetConnection();
            string sqlCmd = @"SELECT DISTINCT QC.PRDID, QC.QCSTY, QC.QCSNM, QC.ALIAS, QC.QCREQ, QC.QCSYA, QC.QCMIN, QC.QCMAX, UNTID, 
                            QT.QCTYP, QT.QCTNM, QC.ALIAS
                            FROM biopm.QC_REFERENSI_PRODUK QC, biopm.QC_TYPE QT
                            WHERE QT.QCTYP = QC.QCTYP AND QC.PRDID = '" + id + "' ORDER BY QT.QCTNM";
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    qualitycontrols.Add(QualityControlFactory.CreateQualityControl(reader[0].ToString(), reader[1].ToString(), reader[2].ToString(), reader[3].ToString(), reader[4].ToString(), reader[5].ToString(),
                        reader[6].ToString(), reader[7].ToString(), reader[8].ToString(), reader[9].ToString(), reader[10].ToString(), reader[11].ToString()));
                }
        ...
        public static List<QualityControl> GetAllQualityControl()
        {
            SqlConnection conn = GetConnection();
            string sqlCmd = @"SELECT DISTINCT QC.PRDID, QC.QCSTY, QC.QCSNM, QC.ALIAS, QC.QCREQ, QC.QCSYA, QC.QCMIN, QC.QCMAX, UNTID, QT.QCTYP, 
                            QT.QCTNM, QC.ALIAS
                            FROM biopm.QC_REFERENSI_PRODUK QC, biopm.QC_TYPE QT
                            WHERE QT.QCTYP = QC.QCTYP ORDER BY QC.QCSNM";
            SqlCommand cmd = GetCommand(conn, sqlCmd);
