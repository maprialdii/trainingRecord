<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateRawMaterialSampleCloned.aspx.cs" Inherits="BioPM.FormGenerateRawMaterialSampleCloned" %>
...
<script runat="server">
    ...
    {
        txtSetNumberLabel.Text = BioPM.ClassObjects.RawMaterialCatalog.GetAvailableNumberOfSetByID(ddlExistingBatch.SelectedValue).ToString();
    ...
    protected void SetBatchInput()
    {
        ...
        {
            txtSetNumberLabel.Visible = false;
            txtSetNumber.Visible = true;
            txtSetNumber.Text = "";
        ...
        {
            txtSetNumberLabel.Visible = true;
            txtSetNumber.Visible = false;
            SetNumberOfSet();
    ...
    protected void InsertRawMaterialIntoDatabase()
    {
        ...
        {
            if (i < numberofsample) BioPM.ClassObjects.RawMaterialCatalog.InsertRawMaterialSample(txtBatch.Text, RNDID, QCMID, txtRandomDate.Text, samplenumber.ToString(), numbers[i].ToString(), "1", Session["username"].ToString());
            else BioPM.ClassObjects.RawMaterialCatalog.InsertRawMaterialSample(txtBatch.Text, RNDID, QCMID, txtRandomDate.Text, "0", numbers[i].ToString(), "0", Session["username"].ToString());
    ...
    protected void RunRandomToGetRawMaterialSample()
    {
        ...
        else if (!BioPM.ClassEngines.ValidationFactory.ValidateNullInput(txtBatch.Text) && ddlQCType.SelectedValue == "0")
        {
        ...
        else if (ddlQCType.SelectedValue == "1")
        {
            ...
            else if (!BioPM.ClassEngines.ValidationFactory.ValidateToCompareValue(Convert.ToInt16(txtSampleNumber.Text), Convert.ToInt16(txtSetNumberLabel.Text)))
            {
                ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + BioPM.ClassEngines.ValidationFactory.GetErrorMessage(3, "NUMBER OF SET", "NUMBER OF SAMPLE") + "');", true);
            } 
            else
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <asp:TextBox ID="txtBatch" runat="server" class="form-control m-bot15" Visible="false" placeholder="NEW GIN" ></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <asp:TextBox ID="txtSetNumber" runat="server" class="form-control m-bot15" placeholder="NUMBER OF SET" ></asp:TextBox>
                                <asp:Label ID="txtSetNumberLabel" runat="server" class="form-control m-bot15"></asp:Label>
                            </div>
                        </div>
