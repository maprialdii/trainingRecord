...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageBatchProductQualityControlApproval.aspx.cs" Inherits="BioPM.PageBatchProductQualityControlApproval" %>
...
<script runat="server">
    ...
    protected string GetPageAction(string BATCH)
    {
        ...
        else
        {
            switch (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "1")[2].ToString().ToLower())
            {
                ...
                case "review":
                    {
                        return "<td align='center'><a class='edit' href='PageQualityControlTransactionApproval.aspx?key=" + BATCH + "'> APPROVE </a></td>";
                    }
                case "corection":
                    {
                        return "<td align='center'></td>";
    ...
    protected String GenerateDataBatch()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.BatchCatalog.GetBatchByReviewerAndType(Session["username"].ToString(), "2"))
        {
