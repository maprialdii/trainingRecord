<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageBatchProductQualityAssuranceApproval.aspx.cs" Inherits="BioPM.PageBatchProductQualityAssuranceApproval" %>
    ...
    protected string GetPageAction(string BATCH)
    {
        ...
        else
        {
            switch (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndType(BATCH, "3")[2].ToString().ToLower())
            {
                ...
                case "qa release":
                    {
                        return "<td align='center'><a class='edit' href='PageQualityAssuranceTransactionApproval.aspx?key=" + BATCH + "'> APPROVE </a></td>";
                    }
                default:
                    {
                        return "<td align='center'></td>";
