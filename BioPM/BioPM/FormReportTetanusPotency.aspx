<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormReportTetanusPotency.aspx.cs" Inherits="BioPM.FormReportTetanusPotency" %>
...
<script runat="server">
    ...
    protected void GetQCRandomDateTest()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.QualityControlCatalog.GetQCTestRandomDate("14"))
        {
...
<head>
    ...
    <title>QC TETANUS POTENCY REPORT</title>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        QC TETANUS POTENCY REPORT ENTRY FORM
