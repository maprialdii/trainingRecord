                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <textarea id="TextArea1" cols="60" name="S1" rows="3"></textarea>
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> Alasan: </label>
                            <div class="col-lg-3 col-md-4">
                                <textarea id="TextArea2" cols="60" name="S1" rows="3"></textarea>
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> Alasan: </label>
                            <div class="col-lg-3 col-md-4">
                                <textarea id="TextArea3" cols="60" name="S1" rows="3"></textarea>
                                </div>
                        </div>
