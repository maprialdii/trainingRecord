<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageProductionTransactionApproval.aspx.cs" Inherits="BioPM.PageProductionTransactionApproval" %>
...
<script runat="server">
    ...
    protected void SetDataToForm()
    {
        ...
        if (BioPM.ClassObjects.ProductionCatalog.ValidateProductBatch(BATCH) >= 1)
        {
            ...
            txtProductStatus.Text = BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "2") == null ? "QUARANTINE" : BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "2")[2].ToString().ToUpper();
    ...
    {
        BioPM.ClassObjects.ProductionCatalog.InsertProductionTransactionFlow(txtBatch.Text, "1", ddlApprovalStatus.SelectedValue, Session["username"].ToString().ToString(), txtNote.Text, Session["username"].ToString());
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (Session["password"].ToString() == BioPM.ClassEngines.CryptographFactory.Encrypt(txtConfirmation.Text, true))
        {
            ...
            if (ddlApprovalStatus.SelectedValue == "RELEASE" && BioPM.ClassObjects.BatchCatalog.GetBatchByFlowTypeStatus(txtBatch.Text, "2", "RELEASE") == 1)
            {
                BioPM.ClassObjects.ProductionCatalog.InsertProductionTransactionFlow(txtBatch.Text, "3", "QA QUARANTINE", "", "", Session["username"].ToString());
            }
            Response.Redirect("PageBatchProductProductionApproval.aspx");
        }
        else
        {
...
<head>
    ...
    <title>Production Approval</title>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        Production Transaction Approval
