...
<script runat="server">
    ...
    protected String GenerateDataProduk()
    {
        ...
        {
            htmlelement += "<tr class=''><td>" + data[0].ToString() + "</td><td>" + data[1].ToString() + "</td><td>" + data[2].ToString() + "</td><td>" + data[3].ToString() + "</td><td><a class='edit' href='PageEmployeeDetail.aspx?key=" + data[0].ToString() + "'>View Detail</a></td></tr>";
        }
