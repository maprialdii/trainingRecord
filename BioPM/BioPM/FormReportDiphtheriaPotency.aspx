<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormReportDiphtheriaPotency.aspx.cs" Inherits="BioPM.FormReportDiphtheriaPotency" %>
...
<script runat="server">
    ...
    protected void GetQCRandomDateTest()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.QualityControlCatalog.GetQCTestRandomDate("13"))
        {
...
<head>
    ...
    <title>QC DIPHTHERIA POTENCY REPORT</title>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        QC DIPHTHERIA POTENCY REPORT ENTRY FORM
