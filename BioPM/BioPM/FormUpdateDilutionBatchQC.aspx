<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormUpdateDilutionBatchQC.aspx.cs" Inherits="BioPM.FormUpdateDilutionBatchQC" %>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <asp:TextBox ID="txtDilutionConcentration" runat="server" class="form-control m-bot15" placeholder="DILUTION CONCENTRATION" ></asp:TextBox>
                            </div>
                        </div>
