<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageProductTransaction.aspx.cs" Inherits="BioPM.PageProductTransaction" %>
...
<script runat="server">
    ...
    private System.Data.DataTable _QCData
    {
        get
        {
            ...
            if (dt == null)
            {
                ...
                //dt.Columns.Add(new System.Data.DataColumn("QCSNM", typeof(string)));
                dt.Columns.Add(new System.Data.DataColumn("QCREQ", typeof(string)));
                //dt.Columns.Add(new System.Data.DataColumn("QCDAT", typeof(string)));
                dt.Columns.Add(new System.Data.DataColumn("QCRST", typeof(string)));
                //dt.Columns.Add(new System.Data.DataColumn("QCDET", typeof(string)));
    ...
    protected void SetLabelVisible()
    {
        ...
        if (_QCData.Rows.Count > 0) ddlQCReview.Visible = true;
        else ddlQCReview.Visible = false;

        if (_FormulaData.Rows.Count > 0) ddlFormulaReview.Visible = true;
        else ddlFormulaReview.Visible = false;
    }
    ...
    protected void SetLabelInvisible()
    {
        ...
        ddlQCReview.Visible = false;
        ddlFormulaReview.Visible = false;
    }
    ...
    protected void GenerateDataQC()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.ProductionCatalog.GetProductQCByBatch(txtBatch.Text))
        {
            System.Data.DataTable dt = _QCData;
            int newid = dt.Rows.Count + 1;
            dt.Rows.Add(new object[] { index.ToString(), data[4].ToString(), data[7].ToString(), "" });
            index++;
            _QCData = dt;
        }
        this.GridViewQC.DataSource = _QCData;
    ...
    protected void GenerateDataFormula()
    {
        int index = 1;
        _FormulaData = null;
        foreach (object[] data in BioPM.ClassObjects.ProductionCatalog.GetProductFormulaByBatch(txtBatch.Text))
        {
            System.Data.DataTable dt = _FormulaData;
            int newid = dt.Rows.Count + 1;
            dt.Rows.Add(new object[] { index.ToString(), data[3].ToString(), data[4].ToString(), Convert.ToDecimal(data[5].ToString()).ToString("F"), data[6].ToString() });
            index++;
            _FormulaData = dt;
        }
        this.GridViewFormula.DataSource = _FormulaData;
                            ...
                            <div class="panel">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <%--<label class="col-sm-3 control-label"> </label>--%>
                                        <div class="col-sm-3">
                                        <asp:DropDownList runat="server" Visible="false" ID="ddlQCReview" class="col-sm-1 form-control m-bot15">
                                            <asp:ListItem Value="1">Quarantine</asp:ListItem> 
                            ...
                            <div class="panel">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <%--<label class="col-sm-3 control-label"> </label>--%>
                                        <div class="col-sm-3">
                                        <asp:DropDownList runat="server" Visible="false" ID="ddlFormulaReview" class="col-sm-1 form-control m-bot15">
                                            <asp:ListItem Value="1">Quarantine</asp:ListItem> 
                                            <asp:ListItem Value="2">Reject</asp:ListItem> 
                                            <asp:ListItem Value="3">Release</asp:ListItem> 
                                        </asp:DropDownList>
