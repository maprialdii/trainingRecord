<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageQualityControlTransactionApproval.aspx.cs" Inherits="BioPM.PageQualityControlTransactionApproval" %>
...
<script runat="server">
    ...
    {
        BioPM.ClassObjects.ProductionCatalog.InsertProductionTransactionFlow(txtBatch.Text, "2", ddlApprovalStatus.SelectedValue, Session["username"].ToString().ToString(), txtNote.Text, Session["username"].ToString());
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (Session["password"].ToString() == BioPM.ClassEngines.CryptographFactory.Encrypt(txtConfirmation.Text, true))
        {
            ...
            if (ddlApprovalStatus.SelectedValue == "RELEASE" && BioPM.ClassObjects.BatchCatalog.GetBatchByFlowTypeStatus(txtBatch.Text, "1","RELEASE") == 1)
            {
            ...
            Response.Redirect("PageBatchProductQualityControlApproval.aspx");
        }
        else
        {
