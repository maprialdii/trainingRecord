<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageCompetencyRelationTable.aspx.cs" Inherits="BioPM.PageCompetencyRelationTable" %>
                             ...
                             <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>You Are Logged In As <% Response.Write(Session["name"].ToString()); %></p><br />
                                        <p>Are you sure to insert into database?</p>
                                        <asp:TextBox ID="TextBox1" runat="server" TextMode="Password" placeholder="Confirmation Password" class="form-control placeholder-no-fix"></asp:TextBox>
                                    ...
                                    <div class="modal-footer">
                                        <asp:Button ID="Button1" runat="server" data-dismiss="modal" class="btn btn-default" Text="Cancel"></asp:Button>
                                        <asp:Button ID="Button2" runat="server" class="btn btn-success" Text="Confirm" OnClick="btnDel_Click"></asp:Button>
                                    </div>
                                </div>
                            </div>
                        </div>
