<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageBatchProductQualityControlReview.aspx.cs" Inherits="BioPM.PageBatchProductQualityControlReview" %>
    ...
    protected string GetPageAction(string BATCH)
    {
        ...
        else
        {
            switch (BioPM.ClassObjects.ProductionCatalog.GetProductionStatusByBatchAndUntype(BATCH, "1")[2].ToString().ToLower())
            {
                case "quarantine":
                    {
                        return "<td align='center'><a class='edit' href='PageQualityControlTransactionReview.aspx?key=" + BATCH + "'> REVIEW </a></td>";
                    }
                case "review":
                    {
                        return "<td align='center'></td>";
