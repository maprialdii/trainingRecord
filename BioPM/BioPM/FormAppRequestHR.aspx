...
<script runat="server">
    ...
    protected String GenerateRequestedPlan()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.ComDevPlan.GetComdevPlanByStatus("Confirmed") )
        {
            ...
            htmlelement += "<tr class=''><td>" + data[7].ToString() + "</td><td>" + data[5].ToString() + "</td><td>" + data[1].ToString() + "</td><td>" + data[3].ToString() + "</td><td>" + values[2].ToString() + "</td><td>" + values[3].ToString() + "</td><td><a class='edit' href='FormApprove.aspx?key=" + data[0].ToString() + "&event=" + data[9].ToString() + "'>Approve</a></td><td><a class='edit' href='PageInformation.aspx?key=" + data[0].ToString() + "&type=33'>Reject</a></td></tr>";
        }

        foreach (object[] data in BioPM.ClassObjects.ComDevPlan.GetComdevPlanByStatus("Suggested"))
        {
            values = BioPM.ClassObjects.EmployeeCatalog.GetEmployeeByID(data[8].ToString());
            htmlelement += "<tr class=''><td>" + data[7].ToString() + "</td><td>" + data[5].ToString() + "</td><td>" + data[1].ToString() + "</td><td>" + data[3].ToString() + "</td><td>" + values[2].ToString() + "</td><td>" + values[3].ToString() + "</td><td><a class='edit' href='FormApprove.aspx?key=" + data[0].ToString() + "&event=" + data[9].ToString() + "'>Approve</a></td><td><a class='edit' href='PageInformation.aspx?key=" + data[0].ToString() + "&type=33'>Reject</a></td></tr>";
        }
