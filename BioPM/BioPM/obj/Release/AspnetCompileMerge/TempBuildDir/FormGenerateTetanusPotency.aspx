<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGenerateTetanusPotency.aspx.cs" Inherits="BioPM.FormGenerateTetanusPotency" %>
...
<script runat="server">
    ...
    protected void GetRandomAnimalDate()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.QualityControlCatalog.GetAnimalRandomDateByType("14"))
        {
    ...
    protected void InsertDilutionTestIntoDatabase()
    {
        ...
        for (int i = 0; i < ((dilution * animalperdilution) / animalpercage); i++)
        {
            BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "14", itemid, numbers[i].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
            if ((i + 1) % dilutionnumberdivided == 0) dilutionnumber++;
            if ((i + 1) % samplenumberdivided == 0) samplenumber++;
        }
    }
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        TETANUS POTENCY RANDOM SAMPLE ENTRY FORM
