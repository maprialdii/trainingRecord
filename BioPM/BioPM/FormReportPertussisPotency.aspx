<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormReportPertussisPotency.aspx.cs" Inherits="BioPM.FormReportPertussisPotency" %>
...
<script runat="server">
    ...
    protected void GetQCRandomDateTest()
    {
        ...
        foreach (object[] data in BioPM.ClassObjects.QualityControlCatalog.GetQCTestRandomDate("15"))
        {
...
<head>
    ...
    <title>QC PERTUSSIS POTENCY REPORT</title>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        QC PERTUSSIS POTENCY REPORT ENTRY FORM
