<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageQualityAssuranceTransactionReviewSecondStage.aspx.cs" Inherits="BioPM.PageQualityAssuranceTransactionReviewSecondStage" %>
...
<script runat="server">
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (Session["password"].ToString() == BioPM.ClassEngines.CryptographFactory.Encrypt(txtConfirmation.Text, true))
        {
            ...
            Response.Redirect("PageBatchProductQualityAssuranceReview.aspx");
        }
        else
        {
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <asp:DropDownList ID="ddlApprovalStatus" runat="server" class="form-control m-bot15">
                                            <asp:ListItem Value="QA RELEASE">Release</asp:ListItem> 
                                            <asp:ListItem Value="QA REJECT">Reject</asp:ListItem>
                                        </asp:DropDownList>
