<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormGeneratePertussisPotency.aspx.cs" Inherits="BioPM.FormGeneratePertussisPotency" %>
...
<script runat="server">
    ...
    protected void InsertDilutionTestIntoDatabase()
    {
        ...
        {
            BioPM.ClassObjects.QualityControlCatalog.InsertQCDilutionTest(txtRandomDate.Text, ddlRandomDate.SelectedValue, QCTID, "15", itemid, numbers[i].ToString(), dilutionnumber.ToString(), samplenumber.ToString(), Session["username"].ToString());
