<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormUpdateSample.aspx.cs" Inherits="BioPM.FormUpdateSample" %>
                ...
                for (int i = _firstEditCellIndex; i < _gridView.Columns.Count; i++)
                {
                    ...
                    if (_editControl.Visible)
                    {
                        ...
                        try
                        {
                            ...
                            Label idLabel = (Label)_gridView.Rows[e.RowIndex].FindControl("CAGNOLabel");
                    ...
                    <div class="panel-body">
                        ...
                        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#e9ecef" AutoGenerateColumns="False"  
                            ...
                            <Columns>                 
                                ...
                                <asp:TemplateField HeaderText="Cage Number"> 
                                    <ItemTemplate> 
                                        <asp:Label ID="CAGNOLabel" runat="server" Text='<%# Eval("CAGNO") %>'></asp:Label>                         
                                    </ItemTemplate>                
                                </asp:TemplateField> 
