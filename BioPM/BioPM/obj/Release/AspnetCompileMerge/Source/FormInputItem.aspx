<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormInputItem.aspx.cs" Inherits="BioPM.FormInputItem" %>
...
<script runat="server">
    ...
    protected void InsertItemIntoDatabase()
    {
        BioPM.ClassObjects.Item item = BioPM.ClassObjects.ItemFactory.CreateItem(txtItemID.Text, txtItemName.Text, txtItemUnit.Text, itemgroup.ItemGroupID, "");
        BioPM.ClassEngines.ObjectFactory.InsertDataItem(item, Session["username"].ToString());
    }

    protected void btnAdd_Click(object sender, EventArgs e)
    {
        if (IsPostBack) InsertItemIntoDatabase();
        Response.Redirect("PageItem.aspx?key="+ Session["itemgroupid"].ToString());
    }
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                         <% Response.Write(itemgroup.ItemGroupID + " - " + itemgroup.ItemGroupName); %> | Item Entry Form
