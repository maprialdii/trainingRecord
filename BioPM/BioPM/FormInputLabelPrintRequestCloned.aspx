<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormInputLabelPrintRequestCloned.aspx.cs" Inherits="BioPM.FormInputLabelPrintRequestCloned" %>
...
<script runat="server">
    ...
    protected void InsertLabelPrintData()
    {
        ...
        BioPM.ClassObjects.LabelCatalog.InsertLabelPrintData(Session["PRTID"].ToString(), ddlBatch.SelectedValue, "", txtQuantity.Text, txtRequestDate.Text, values[4].ToString(), "", "", "", Session["username"].ToString());
    }
